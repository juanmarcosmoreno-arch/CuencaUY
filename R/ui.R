    ...
    div(class = "panel-body",
      ...
      radio_group("indicator",
                  ...
                  subtitles = unname(c(prod = "Litros, todos los destinos", venta = "Litros vendidos",
                                       dens = "Litros por km² de territorio", rem = "DICOSE con venta a industria",
                                       vacas = "Vaca masa: en ordeñe + secas", lpv = "Productividad del rodeo",
                                       tambos = "Productores lecheros (DIEA)",
                                       lluvia = "% respecto a 1991–2020",
                                       thi = "Días con THI ≥ 72")[names(inds)]),
                  separators = list(
                    vacas = tagList(span("Rodeo y tambos")),
                    lluvia = tagList(span("Clima"), span(class = "choice-sep-sub", "La altura sigue mostrando la producción")))),
